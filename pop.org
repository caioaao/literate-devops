...
** iptables
   ...
   #+begin_src shell :tangle /sudo::/etc/iptables/iptables-flush.sh :mkdirp true :tangle-mode (identity #o755)
     #!/usr/bin/env bash
     iptables -F
     iptables -X
     iptables -t nat -F
...
*** clojure-lsp
    ...
    #+begin_src shell :dir /sudo::/tmp
      curl -fsSL https://github.com/snoe/clojure-lsp/releases/download/release-20200121T234305/clojure-lsp > clojure-lsp
