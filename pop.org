...
*** Istio
    ...
    #+BEGIN_SRC shell :dir /sudo::
      ...
      ln -sf /opt/istio/istio-1.0.6/bin/istioctl /usr/local/bin/istioctl
      ln -sf /opt/istio/istio-1.0.6 /opt/istio/istio
    #+END_SRC
...
** Terraform
   ...
   #+begin_src shell :dir /sudo::
     mv /tmp/terraform /usr/local/bin/terraform-0.11.11
     ln -sf /usr/local/bin/terraform-0.11.11 /usr/local/bin/terraform
   #+end_src
